...
CONFIG_SPECS: tuple[ConfigSpec, ...] = (
    ...
    ConfigSpec("AUTO_TOOL_CREATION_ENABLED", "0", "bool", "Memoria/Skills", "Crea tools si no hay una relevante."),
    ConfigSpec("AUTO_TOOL_CREATION_MIN_CYCLE", "1", "int", "Memoria/Skills", "Ciclo minimo para crear tools automaticamente."),
    ConfigSpec("PYTHON_SKILL_TIMEOUT", "20", "int", "Memoria/Skills", "Timeout de skills Python generados."),
